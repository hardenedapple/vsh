...
Hello world
demo [13:55:28] $ 
vshcmd: > # In normal mode you can move down a prompt with 'CTRL-N' and up a
vshcmd: > # prompt with 'CTRL-P'.
vshcmd: > # Command lines are executed with '<CR>'. You can run any command
vshcmd: > # line anywhere in the file at any time.
